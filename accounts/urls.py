...
urlpatterns = [
    ...
    path('profile/edit/', views.ProfileUpdateView.as_view(), name='profile_edit'),  # Moved this line up
    path('profile/<str:username>/', views.ProfileDetailView.as_view(), name='profile'),  # This line comes after

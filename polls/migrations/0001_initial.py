    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, verbose_name='Slug')),
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('requires_choices', models.BooleanField(default=False, verbose_name='Requires Choices')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restricted_to_institution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.institutionprofile', verbose_name='Restricted to Institution')),
